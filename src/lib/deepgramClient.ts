...
// Deepgram API information from environment variables
const DEEPGRAM_API_KEY = import.meta.env.VITE_DEEPGRAM_API_KEY;
const DEEPGRAM_API_URL = import.meta.env.VITE_DEEPGRAM_API_URL || 'https://api.deepgram.com/v1/listen';
const DEEPGRAM_TTS_API_URL = import.meta.env.VITE_DEEPGRAM_TTS_API_URL || 'https://api.deepgram.com/v1/speak';
